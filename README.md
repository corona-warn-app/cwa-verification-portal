...
This component provides a simple user interface for the service agents to generate the temporary TAN. For security reasons it cooperates with an IAM component (**I**dentity**A**ccess**M**anagement) using a 2-Factor-Authentification. As mentioned above, the IAM component is hosted in another [project](https://github.com/corona-warn-app/cwa-verification-iam) of the corona-warn-app org.
